...
public class Item {
	...
	public Item(String name, int Size, int Material, int cost, double weight, double thickness, boolean masterwork)
	{
		this.setName(name);
	...
	public static void main(String[] args) {
		Item test = new Item("test",Size.DIMINUTIVE,Material.IRON,30,20,1,false);
